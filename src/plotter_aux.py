...
def save_colors_and_ls(labels):
    ...
    if not dict_color_and_ls:
        ...
        for i, label in enumerate(labels):
            ...
            if label and label in qconfig.dict_of_broken_scaffolds:
                color = dict_color_and_ls[qconfig.dict_of_broken_scaffolds[label]][0]
